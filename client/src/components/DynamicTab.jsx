...
const DynamicTab = () => {
  ...
  return (
    <div className="w-full h-full">
      <div className="w-full flex-1 flex md:flex-row flex-col justify-around items-center gap-10 md:gap-2">
        <motion.div
        ...
        >
          ...
          <motion.section
            className="md:flex hidden flex-row items-center justify-center gap-6 py-2 group-hover:px-6 group transition-all ease-in-out duration-75"
            {...fadeAnimation}
          >
            <img
              src={Posada1_1}
            ...
            <div className="flex flex-col gap-4 lg:items-start items-centers justify-center transition-all ease-in-out duration-75">
              ...
              <p className="text-white font-jakarta font-md text-center lg:group-hover:text-left cursor-pointer hover:underline">
                {" "}
                Conocer más{" "}
              </p>
            </div>
